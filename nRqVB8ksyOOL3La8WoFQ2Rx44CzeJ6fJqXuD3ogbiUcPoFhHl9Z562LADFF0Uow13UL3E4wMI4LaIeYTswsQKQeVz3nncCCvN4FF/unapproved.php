...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>BitBud Limited Unapproved Deposits</title>
           ...
           <form class="form-inline form" method="GET">
             <div class="widget-searchbox">
               ...
               <script>
                   function pwroff()
                   {
                       window.location.href='unapproved.php';
                   }
               </script>
             </div>
           </form>
...
<button class="btnn" onclick='confirm("<?php echo $code; ?>")'><i class="fas fa-check-circle"></i></button>
<button class="btnn1" onclick='reject("<?php echo $code; ?>")'><i class="fas fa-window-close"></i></button>
...
<button class="btnn2" onclick='more("<?php echo $code; ?>")'><i class="far fa-eye"></i></button>
    ...
    function confirm(code)
    {
        ...
        success:function(log)
        {
            ...
            setTimeout(function(){ window.location.href='unapproved.php';},3000)
        }
        })
    }
    </script>
