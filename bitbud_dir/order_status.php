...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>BitBud Limited Order Status</title>
     ...
     <?php  include 'sidebar.php';   ?>      
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <a href='<?php echo "https://bitbud.biz/bitbud_dir/order_status?order_id=$order_id"  ?>' class="float-right ml-auto"><button class="btn btn-info btn-sm" style="height : 35px !important;">Refresh</button></a>
            </div>
