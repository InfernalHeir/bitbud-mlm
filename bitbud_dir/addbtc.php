...
<html lang="en">
  <head>
    ...
    <title>BitBud Limited Add BTC Wallet Address</title>
     ...
     <?php  include 'sidebar.php';   ?>      
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row">
            <h3 class="mt-2" style="font-size:20px;">Add BTC Wallet</h3>
            <span class="ml-3 p-2">
            <div class="inner">
...
#fab {
    ...
    @media only screen and (min-width:200px) and (max-width:479px){
       #full button{
            ...
            <input type="text" class="form-control" placeholder="Add/Update BTC Wallet Address" autocomplete="off" id="btc_wallet" value='<?php  foreach($btc as $btc_wallet){echo $btc_wallet['btc_wallet'];}?>'>    
            </div>    
            </div>
            ...
            <div id="full">
            <button type="button" class="btn btn-dark" onclick="btc()">Add/Update BTC Wallet</button>
            </div>
          ...
          function btc()
          {
            ...
            else
            {
                ...
                success:function(data)
                {
                    ...
                    setTimeout(function(){window.location.href='addbtc.php'},3000)
