...
try
{
      ...
      $select_btc=$conn->prepare("SELECT * FROM `distributed_roi` where `user_id`='$user_id' and `status`='Received'");
    $select_btc->execute();
...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>BitBud Limited Daily ROI</title>
...
function stop()
{
  ...
  <tbody>
    ...
    <td data-label="ROI Amount"><?php echo $dir['daily_roi']." BTC";   ?></td>
