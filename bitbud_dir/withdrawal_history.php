...
try
{
       ...
       $select_btc=$conn->prepare("SELECT * FROM `withdrawal_request` where `user_id`='$user_id'");
    $select_btc->execute();
...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>BitBud Limited Withdrawal History</title>
...
function stop()
{
  ...
  <tbody>
    ...
    <td data-label="Tracking ID"><?php echo $dir['token'];    ?></td>
