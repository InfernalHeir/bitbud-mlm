...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>BitBud Limited Link Expired</title>
...
function stop()
{
     ...
     <?php  include 'sidebar.php';   ?>      
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row">
            <h3 class="mt-2" style="font-size:20px;">Link Expired</h3>
            <span class="ml-3 p-2">
            <div class="inner">
  ...
  <div class="card-header text-center"><?php  echo "Link Expired for Order No. # ".$_GET['order_id'];  ?></div>
  <div class="card-body">

<div class="row w-100 text-center mt-3 mb-3">
  <img src="https://bitbud.biz/bitbud_dir/assets/images/369-3697264_compliance-and-security-lock-icon.png
" class="img-fluid tt">
...
<div class="mt-3 mb-3">
<p style=" font-size: 15px !important;"><b>We </b> Cannot proceed your request because payment url has been expired due to high timeline. if you want again you can regenerate this from <a href="https://bitbud.biz/bitbud_dir/new_deposit.php">"New Deposit"</a>. if any kind of help you want please contact with us we are open 24 hours. Thankyou be with us.</p>    
