...
try
{
      ...
      $select_btc=$conn->prepare("SELECT * FROM `direct_team` where `referel_user_id`='$user_id' and `status`='Activated'");
    $select_btc->execute();
...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>BitBud Limited Referral Income</title>
...
function stop()
{
  ...
  <tbody>
    ...
    <td data-label="Plan"><?php echo $dir['pack'];   ?></td>
    
    <td data-label="Amount"><?php echo $dir['amount'].' BTC';   ?></td>
    <td data-label="Commision"><?php $amount=$dir['amount']; $amount_btc=$amount*10/100; echo $amount_btc.' BTC';   ?></td>
